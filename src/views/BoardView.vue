...
<template>
  ...
  <div class="grid-container" v-if="!isLoading">
    <div class="location-select-sub">
      ...
      <div class="location-select-shield" v-if="!isLoading">
        <p :class="[{ bounce: isBounce }, { slide: isForward }]">{{ currentLocation.name }}</p>
      </div>
      <div
        class="location-button-forward"
